...
- Composite: ***UK*** - Kentucky (64%) def. Arizona (36%)  
...
- Lineup: ***UK*** - Kentucky (67%) def. Arizona (33%)  
...
<li>Composite: <b><i>UK</i></b> - Draxl (77%) def. Strom (23%)</li>  
<li>Slam: <b><i>UK</i></b> - Draxl (86%) def. Strom (14%)</li>  
<li>TRN: <b><i>UK</i></b> - Draxl (71%) def. Strom (29%)</li>  
<li>Massey: <b><i>UK</i></b> - Draxl (66%) def. Strom (34%)</li>  
...
<li>Slam: <b><i>UK</i></b> - Diallo (52%) def. Ziverts (48%)</li>  
<li>TRN: <b><i>UK</i></b> - Diallo (60%) def. Ziverts (40%)</li>  
<li>Massey: <b><i>UK</i></b> - Diallo (68%) def. Ziverts (32%)</li>  
...
<li>Slam: <b><i>UK</i></b> - Hurrion (71%) def. Malbasic (29%)</li>  
<li>TRN: <b><i>UK</i></b> - Hurrion (74%) def. Malbasic (26%)</li>  
<li>Massey: <b><i>UK</i></b> - Hurrion (65%) def. Malbasic (35%)</li>  
<li>UTR: <b><i>UK</i></b> - Hurrion (70%) def. Malbasic (30%)</li>  
<li>ITA: <b><i>UK</i></b> - Hurrion (22.80) def. Malbasic (2.36)</li>  
</ul>
</details>&nbsp;</li>
<li><details>
<summary markdown="span">Herman Hoyeraal (ARIZ) - 0-0 at #4, 4-0 in duals, 4-0 overall<br>Cesar Bourgois (UK) - 9-6 at #4, 14-6 in duals, 14-6 overall</summary>
<h4>Predictions</h4><ul>
<li>Composite: <b><i>UK</i></b> - Bourgois (64%) def. Hoyeraal (36%)</li>  
<li>Slam: <b><i>UK</i></b> - Bourgois (63%) def. Hoyeraal (37%)</li>  
<li>TRN: <b><i>UK</i></b> - Bourgois (51%) def. Hoyeraal (49%)</li>  
<li>Massey: <b><i>UK</i></b> - Bourgois (58%) def. Hoyeraal (42%)</li>  
<li>UTR: <b><i>UK</i></b> - Bourgois (86%) def. Hoyeraal (14%)</li>  
<li>ITA: <b><i>UK</i></b> - Bourgois (7.98) def. Hoyeraal (2.40)</li>  
</ul>
</details>&nbsp;</li>
<li><details>
<summary markdown="span">Alejandro Requant-Bicardi (ARIZ) - 0-0 at #5, 13-6 in duals, 13-6 overall<br>Joshua Lapadat (UK) - 3-3 at #5, 6-9 in duals, 11-10 overall</summary>
<h4>Predictions</h4><ul>
<li>Composite: <b><i>ARIZ</i></b> - Requant-Bicardi (62%) def. Lapadat (38%)</li>  
<li>Slam: <b><i>ARIZ</i></b> - Requant-Bicardi (63%) def. Lapadat (37%)</li>  
<li>TRN: <b><i>ARIZ</i></b> - Requant-Bicardi (54%) def. Lapadat (46%)</li>  
<li>Massey: <b><i>ARIZ</i></b> - Requant-Bicardi (53%) def. Lapadat (47%)</li>  
<li>UTR: <b><i>ARIZ</i></b> - Requant-Bicardi (78%) def. Lapadat (22%)</li>  
<li>ITA: <b><i>UK</i></b> - Lapadat (6.21) def. Requant-Bicardi (2.55)</li>  
</ul>
</details>&nbsp;</li>
<li><details>
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>ARIZ</i></b> - Hassey (75%) def. LeBlanc (25%)</li>  
<li>Slam: <b><i>ARIZ</i></b> - Hassey (79%) def. LeBlanc (21%)</li>  
<li>TRN: <b><i>ARIZ</i></b> - Hassey (81%) def. LeBlanc (19%)</li>  
<li>Massey: <b><i>ARIZ</i></b> - Hassey (62%) def. LeBlanc (38%)</li>  
<li>UTR: <b><i>ARIZ</i></b> - Hassey (80%) def. LeBlanc (20%)</li>  
<li>ITA: <b><i>UK</i></b> - # LeBlanc def. Hassey (1.70)</li>  
</ul>
</details>&nbsp;</li>
</ol>
...
<ol>
<li><details>
<summary markdown="span">Hassey/Requant-Bicardi (ARIZ) - 1-0 at #1, 10-3 in duals, 10-3 overall<br>Diallo/Bourgois (UK) - 14-7 at #1, 14-7 in duals, 14-7 overall</summary>
<br>Sorry, we don't have any metrics for this match
</details>&nbsp;</li>
<li><details>
<summary markdown="span">Ziverts/Hoyeraal (ARIZ) - 0-0 at #2, 0-0 in duals, 0-0 overall<br>Draxl/Hurrion (UK) - 6-2 at #2, 6-2 in duals, 6-2 overall</summary>
<br>Sorry, we don't have any metrics for this match
</details>&nbsp;</li>
<li><details>
...
- Kentucky should win 4 or more singles matches *46%* of the time.  
- Arizona should win 4 or more singles matches *22%* of the time.  
...
- If Arizona wins the doubles point, their chances of winning the dual improve to *54%*.  
