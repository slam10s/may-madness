...
- Massey: ***TEX*** - #11 Texas (60%) def. #16 South Carolina (40%)  
- Lineup: ***SCAR*** - South Carolina (60%) def. Texas (40%)  
...
<li>Composite: <b><i>SCAR</i></b> - Rodrigues (75%) def. Spizzirri (25%)</li>  
<li>Slam: <b><i>SCAR</i></b> - Rodrigues (75%) def. Spizzirri (25%)</li>  
<li>TRN: <b><i>SCAR</i></b> - Rodrigues (71%) def. Spizzirri (29%)</li>  
<li>Massey: <b><i>SCAR</i></b> - Rodrigues (74%) def. Spizzirri (26%)</li>  
...
<li>Massey: <b><i>TEX</i></b> - Braswell (59%) def. Thomson (41%)</li>  
...
<li>Massey: <b><i>SCAR</i></b> - Samuel (66%) def. Woldeab (34%)</li>  
...
<li>TRN: <b><i>TEX</i></b> - Harper (64%) def. Lambling (36%)</li>  
<li>Massey: <b><i>TEX</i></b> - Harper (65%) def. Lambling (35%)</li>  
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>SCAR</i></b> - Beasley (62%) def. Huang (38%)</li>  
<li>Slam: <b><i>SCAR</i></b> - Beasley (59%) def. Huang (41%)</li>  
<li>TRN: <b><i>SCAR</i></b> - Beasley (67%) def. Huang (33%)</li>  
<li>Massey: <b><i>SCAR</i></b> - Beasley (58%) def. Huang (42%)</li>  
<li>UTR: <b><i>SCAR</i></b> - Beasley (64%) def. Huang (36%)</li>  
<li>ITA: <b><i>SCAR</i></b> - Beasley (1.73) def. Huang (0.00)</li>  
</ul>
</details>&nbsp;</li>
<li><details>
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>SCAR</i></b> - Brown (56%) def. McDonald (44%)</li>  
<li>Slam: <b><i>SCAR</i></b> - Brown (62%) def. McDonald (38%)</li>  
<li>TRN: <b><i>SCAR</i></b> - Brown (62%) def. McDonald (38%)</li>  
<li>Massey: <b><i>SCAR</i></b> - Brown (53%) def. McDonald (47%)</li>  
<li>UTR: <b><i>TEX</i></b> - McDonald (53%) def. Brown (47%)</li>  
<li>ITA: <b><i>SCAR</i></b> - Brown (2.19) def. McDonald (0.00)</li>  
</ul>
</details>&nbsp;</li>
</ol>
...
- Texas should win 4 or more singles matches *27%* of the time.  
- South Carolina should win 4 or more singles matches *41%* of the time.  
- The winner of the doubles point should decide the match the other *32%* of the time.  
- If Texas wins the doubles point, their chances of winning the dual improve to *59%*.  
- If South Carolina wins the doubles point, their chances of winning the dual improve to *73%*.  
