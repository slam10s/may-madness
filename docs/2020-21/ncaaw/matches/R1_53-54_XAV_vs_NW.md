...
- Northwestern should win 4 or more singles matches *99%* of the time.  
- Xavier should win 4 or more singles matches *1%* of the time.  
- The winner of the doubles point should decide the match the other *1%* of the time.  
- If Northwestern wins the doubles point, their chances of winning the dual improve to *99%*.  
- If Xavier wins the doubles point, their chances of winning the dual improve to *1%*.  
