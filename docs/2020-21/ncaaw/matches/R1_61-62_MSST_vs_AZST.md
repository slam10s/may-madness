...
- Composite: ***AZST*** - Arizona St. (79%) def. Mississippi St. (21%)  
- Slam: ***AZST*** - #31 Arizona St. (71%) def. #42 Mississippi St. (29%)  
- TRN: ***AZST*** - #33 Arizona St. (64%) def. #39 Mississippi St. (36%)  
- Massey: ***AZST*** - #24 Arizona St. (97%) def. #45 Mississippi St. (3%)  
...
<li>Slam: <b><i>AZST</i></b> - Hattingh (62%) def. Antonaki (38%)</li>  
<li>TRN: <b><i>MSST</i></b> - Antonaki (55%) def. Hattingh (45%)</li>  
<li>Massey: <b><i>MSST</i></b> - Antonaki (55%) def. Hattingh (45%)</li>  
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>AZST</i></b> - Hampton (57%) def. Adaloglou (43%)</li>  
<li>Slam: <b><i>AZST</i></b> - Hampton (63%) def. Adaloglou (37%)</li>  
<li>TRN: <b><i>AZST</i></b> - Hampton (54%) def. Adaloglou (46%)</li>  
<li>Massey: <b><i>AZST</i></b> - Hampton (66%) def. Adaloglou (34%)</li>  
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>AZST</i></b> - Morlet (74%) def. Mikhailuk (26%)</li>  
<li>Slam: <b><i>AZST</i></b> - Morlet (69%) def. Mikhailuk (31%)</li>  
<li>TRN: <b><i>AZST</i></b> - Morlet (69%) def. Mikhailuk (31%)</li>  
<li>Massey: <b><i>AZST</i></b> - Morlet (75%) def. Mikhailuk (25%)</li>  
<li>UTR: <b><i>AZST</i></b> - Morlet (82%) def. Mikhailuk (18%)</li>  
<li>ITA: <b><i>MSST</i></b> - # Mikhailuk def. Morlet (2.20)</li>  
</ul>
</details>&nbsp;</li>
<li><details>
...
<li>Slam: <b><i>AZST</i></b> - Argyrokastriti (70%) def. Poling (30%)</li>  
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>AZST</i></b> - Turkovic (54%) def. Cirotte (46%)</li>  
<li>Slam: <b><i>AZST</i></b> - Turkovic (52%) def. Cirotte (48%)</li>  
<li>TRN: <b><i>MSST</i></b> - Cirotte (53%) def. Turkovic (47%)</li>  
<li>Massey: <b><i>AZST</i></b> - Turkovic (62%) def. Cirotte (38%)</li>  
...
- Arizona St. should win 4 or more singles matches *64%* of the time.  
- Mississippi St. should win 4 or more singles matches *12%* of the time.  
- The winner of the doubles point should decide the match the other *24%* of the time.  
- If Arizona St. wins the doubles point, their chances of winning the dual improve to *88%*.  
- If Mississippi St. wins the doubles point, their chances of winning the dual improve to *36%*.  
