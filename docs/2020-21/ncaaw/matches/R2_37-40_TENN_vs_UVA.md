...
- Composite: ***UVA*** - Virginia (72%) def. Tennessee (28%)  
- Slam: ***UVA*** - #9 Virginia (69%) def. #19 Tennessee (31%)  
- TRN: ***UVA*** - #11 Virginia (67%) def. #19 Tennessee (33%)  
- Massey: ***UVA*** - #7 Virginia (80%) def. #19 Tennessee (20%)  
- Lineup: ***UVA*** - Virginia (70%) def. Tennessee (30%)  
...
<li>Massey: <b><i>UVA</i></b> - Navarro (91%) def. Mertena (9%)</li>  
...
<li>TRN: <b><i>UVA</i></b> - Subhash (90%) def. Molinaro (10%)</li>  
<li>Massey: <b><i>UVA</i></b> - Subhash (92%) def. Molinaro (8%)</li>  
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>UVA</i></b> - Johanson (76%) def. Briggs (24%)</li>  
<li>Slam: <b><i>UVA</i></b> - Johanson (67%) def. Briggs (33%)</li>  
<li>TRN: <b><i>UVA</i></b> - Johanson (75%) def. Briggs (25%)</li>  
<li>Massey: <b><i>UVA</i></b> - Johanson (78%) def. Briggs (22%)</li>  
...
<li>Slam: <b><i>TENN</i></b> - Kuczer (71%) def. Shaikh (29%)</li>  
<li>TRN: <b><i>TENN</i></b> - Kuczer (86%) def. Shaikh (14%)</li>  
<li>Massey: <b><i>TENN</i></b> - Kuczer (76%) def. Shaikh (24%)</li>  
<li>UTR: <b><i>TENN</i></b> - Kuczer (85%) def. Shaikh (15%)</li>  
<li>ITA: <b><i>TENN</i></b> - Kuczer (3.41) def. Shaikh (1.63)</li>  
</ul>
</details>&nbsp;</li>
<li><details>
<summary markdown="span">Tenika McGiffin (TENN) - 6-0 at #5, 15-4 in duals, 20-12 overall<br>Amber ODell (UVA) - 1-3 at #5, 10-7 in duals, 10-9 overall</summary>
<h4>Predictions</h4><ul>
<li>Composite: <b><i>TENN</i></b> - McGiffin (79%) def. ODell (21%)</li>  
<li>Slam: <b><i>TENN</i></b> - McGiffin (85%) def. ODell (15%)</li>  
<li>TRN: <b><i>TENN</i></b> - McGiffin (80%) def. ODell (20%)</li>  
<li>Massey: <b><i>TENN</i></b> - McGiffin (63%) def. ODell (37%)</li>  
<li>UTR: <b><i>TENN</i></b> - McGiffin (89%) def. ODell (11%)</li>  
<li>ITA: <b><i>TENN</i></b> - McGiffin (1.61) def. ODell (1.59)</li>  
</ul>
</details>&nbsp;</li>
<li><details>
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>TENN</i></b> - Silva (67%) def. Glozman (33%)</li>  
<li>Slam: <b><i>TENN</i></b> - Silva (66%) def. Glozman (34%)</li>  
<li>TRN: <b><i>TENN</i></b> - Silva (62%) def. Glozman (38%)</li>  
<li>Massey: <b><i>TENN</i></b> - Silva (57%) def. Glozman (43%)</li>  
...
- Virginia should win 4 or more singles matches *41%* of the time.  
- Tennessee should win 4 or more singles matches *17%* of the time.  
- The winner of the doubles point should decide the match the other *42%* of the time.  
- If Virginia wins the doubles point, their chances of winning the dual improve to *83%*.  
- If Tennessee wins the doubles point, their chances of winning the dual improve to *59%*.  
