...
- Slam: ***TEX*** - #2 Texas (97%) def. #8 Florida St. (3%)  
- TRN: ***TEX*** - #2 Texas (99%) def. #9 Florida St. (1%)  
- Massey: ***TEX*** - #2 Texas (92%) def. #10 Florida St. (8%)  
- Lineup: ***TEX*** - Texas (97%) def. Florida St. (3%)  
- UTR: ***TEX*** - #1 Texas (+2.89) def. #11 Florida St. (-2.89)  
...
<li>Composite: <b><i>TEX</i></b> - Stearns (57%) def. Pairone (43%)</li>  
<li>Slam: <b><i>FSU</i></b> - Pairone (51%) def. Stearns (49%)</li>  
<li>TRN: <b><i>FSU</i></b> - Pairone (53%) def. Stearns (47%)</li>  
<li>Massey: <b><i>TEX</i></b> - Stearns (58%) def. Pairone (42%)</li>  
<li>UTR: <b><i>TEX</i></b> - Stearns (76%) def. Pairone (24%)</li>  
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>TEX</i></b> - Turati (85%) def. Salas (15%)</li>  
<li>Slam: <b><i>TEX</i></b> - Turati (90%) def. Salas (10%)</li>  
<li>TRN: <b><i>TEX</i></b> - Turati (90%) def. Salas (10%)</li>  
<li>Massey: <b><i>TEX</i></b> - Turati (78%) def. Salas (22%)</li>  
<li>UTR: <b><i>TEX</i></b> - Turati (81%) def. Salas (19%)</li>  
...
<li>Slam: <b><i>TEX</i></b> - Sun (86%) def. Das (14%)</li>  
<li>TRN: <b><i>TEX</i></b> - Sun (93%) def. Das (7%)</li>  
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>TEX</i></b> - Chavatipon (84%) def. Hule (16%)</li>  
<li>Slam: <b><i>TEX</i></b> - Chavatipon (87%) def. Hule (13%)</li>  
<li>TRN: <b><i>TEX</i></b> - Chavatipon (90%) def. Hule (10%)</li>  
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>TEX</i></b> - Collins (73%) def. Allen (27%)</li>  
<li>Slam: <b><i>TEX</i></b> - Collins (67%) def. Allen (33%)</li>  
<li>TRN: <b><i>TEX</i></b> - Collins (75%) def. Allen (25%)</li>  
...
<h4>Predictions</h4><ul>
<li>Composite: <b><i>TEX</i></b> - Labraña (72%) def. Arkadianou (28%)</li>  
...
<li>UTR: <b><i>TEX</i></b> - Labraña (61%) def. Arkadianou (39%)</li>  
...
- Texas should win 4 or more singles matches *87%* of the time.  
...
- If Florida St. wins the doubles point, their chances of winning the dual improve to *13%*.  
