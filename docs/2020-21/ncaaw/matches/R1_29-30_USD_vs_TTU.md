...
- San Diego should win 4 or more singles matches _NaN%_ of the time.  
- The winner of the doubles point will decide the match the other _NaN%_ of the time.  
- If Texas Tech wins the doubles point, their chances of winning the dual improve to _NaN%_.  
- If San Diego wins the doubles point, their chances of winning the dual improve to _NaN%_.  
